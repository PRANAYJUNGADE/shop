    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Publish', 'Publish'), ('Dart', 'Dart')], max_length=200)),
                ...
                ('color', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data.color')),
                ('filter_price', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data.filter_price')),
            ],
        ),
    ]
